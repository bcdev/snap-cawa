...
def en_cl(xx, ll):
    ...
    upp = min(low + 1, ll - 1)
    wlo = 1.0 - (xx - low)
    yield int(round(low)), wlo
    yield int(round(upp)), (1 - wlo)
...
def generate_itp(lut):
    ndim = lut.ndim
    if ndim == 1:
        interpolator = interpol_1
    elif ndim == 2:
        interpolator = interpol_2
    elif ndim == 3:
        interpolator = interpol_3
    elif ndim == 4:
        interpolator = interpol_4
    elif ndim == 5:
        interpolator = interpol_5
    elif ndim == 6:
        interpolator = interpol_6
    elif ndim == 7:
        interpolator = interpol_7
    elif ndim == 8:
        interpolator = interpol_8
    elif ndim == 9:
        interpolator = interpol_9
    elif ndim == 10:
        interpolator = interpol_10
    else:
...
def generate_nan_itp(lut):
    ndim = lut.ndim
    if ndim == 1:
        interpolator = interpol_nan_1
    elif ndim == 2:
        interpolator = interpol_nan_2
    elif ndim == 3:
        interpolator = interpol_nan_3
    elif ndim == 4:
        interpolator = interpol_nan_4
    elif ndim == 5:
        interpolator = interpol_5
    elif ndim == 6:
        interpolator = interpol_6
...
def generate_itp_pn(lut):
    ...
    if ndim == 1:
        interpolator = interpol_1pn
    elif ndim == 2:
        interpolator = interpol_2pn
    elif ndim == 3:
        interpolator = interpol_3pn
    elif ndim == 4:
        interpolator = interpol_4pn
    elif ndim == 5:
        interpolator = interpol_5pn
    elif ndim == 6:
        interpolator = interpol_6pn
    elif ndim == 7:
        interpolator = interpol_7pn
    elif ndim == 8:
        interpolator = interpol_8pn
    elif ndim == 9:
        interpolator = interpol_9pn
    elif ndim == 10:
        interpolator = interpol_10pn
    else:
        print 'Not implemented'
        return
