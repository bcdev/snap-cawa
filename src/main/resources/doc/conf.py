...
# -*- coding: utf-8 -*-
#
# CAWA documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'cawa', 'CAWA Documentation',
...
texinfo_documents = [
  (master_doc, 'CAWA', 'CAWA Documentation',
   [author1], 'CAWA', 'One line description of project.',
   'Miscellaneous'),
]
