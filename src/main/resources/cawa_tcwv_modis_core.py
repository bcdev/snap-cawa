...
class CawaTcwvModisCore:
    ...
    def __init__(self, land_lut=os.path.join('.', 'luts', 'land', 'land_core_modis_aqua.nc4'),
                 ocean_lut=os.path.join('.', 'luts', 'ocean', 'ocean_core_modis_aqua.nc4')):
