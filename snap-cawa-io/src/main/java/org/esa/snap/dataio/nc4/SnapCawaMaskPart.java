...
/**
 * Modification of BeamMaskPart for CAWA purposes
 *
 * @author olafd
 */
public class SnapCawaMaskPart extends BeamMaskPart {

    public static final String CAWA_MASK_PREFIX = "cawa";
    ...
    private static void writeMasks(Product p, NFileWriteable ncFile) throws IOException {
        ...
        for (String maskName : maskNames) {
            if (maskName.startsWith(CAWA_MASK_PREFIX)) {
